                    ...
                    {!! Form::open(['action' => 'Barang\MasukController@edit_submit', 'id'=>'form_validation', 'method'=>'PUT','class'=>'form-horizontal']) !!}
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-5 col-xs-5 col-sm-5 col-lg-5">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::text('hargabarang','63500',['class'=>'form-control', 'required', 'autofocus', 'id'=>'harga'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::number('jumlahmasuk','4',['class'=>'form-control', 'required', 'autofocus', 'id'=>'jumlah'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="m-t-5">
                                        {{Form::text('jumlahharga','Rp 254.000,00',['disabled', 'required', 'autofocus', 'id'=>'jumlahharga'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6 m-t-5">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::select('kategori_id', ['1' => 'Headset', '2' => 'Smartphone', '3' => 'Mouse', '4' => 'Makanan'], 3, ['class' => 'form-control show-tick', 'required'])}} 
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                                ...
                                <div class="col-md-4 col-xs-4 col-sm-4 col-lg-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            {{Form::date('tanggal', \Carbon\Carbon::createFromDate(2018,5,19)->format('Y-m-d'),['class'=>'form-control', 'required', 'id'=> "tanggal"])}}
                                        </div>
