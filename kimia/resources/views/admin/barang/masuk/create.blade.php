...
@section('content')
<div onload="myFunction()" class="col-md-8 col-xs-8 col-sm-8 col-lg-8 col-md-offset-2 col-xs-offset-2 col-sm-offset-2 col-lg-offset-2">
    <!-- Horizontal Layout -->
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body col-md-offset-1 col-xs-offset-1 col-sm-offset-1 col-lg-offset-1">
                    {!! Form::open(['action' => 'Barang\MasukController@create_submit', 'id'=>'form_validation', 'method'=>'POST','class'=>'form-horizontal']) !!}
                       <!--  <div class="row clearfix">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-5 col-xs-5 col-sm-5 col-lg-5">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::text('hargabarang','',['class'=>'form-control', 'required', 'autofocus', 'id'=>'harga'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::number('jumlahmasuk','',['class'=>'form-control', 'required', 'autofocus', 'id'=>'jumlah'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="m-t-5">
                                        {{Form::text('jumlahharga','Rp 0,00',['disabled', 'required', 'autofocus', 'id'=>'jumlahharga'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6 m-t-5">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::select('kategori_id', [null => '-Pilih Kategori-', '1' => 'Headset', '2' => 'Smartphone', '3' => 'Mouse', '4' => 'Makanan'], null, ['class' => 'form-control show-tick', 'required'])}} 
                                    </div>
                                </div>
                            </div>
                        </div>
