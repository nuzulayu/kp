                    ...
                    {!! Form::open(['action' => 'Barang\MasukController@edit_submit', 'id'=>'form_validation', 'method'=>'PUT','class'=>'form-horizontal']) !!}
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::number('jumlahmasuk','7',['class'=>'form-control', 'required', 'autofocus', 'id'=>'jumlah'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="m-t-5">
                                        {{Form::text('jumlahharga','Rp 567.000,00',['disabled', 'required', 'autofocus', 'id'=>'jumlahharga'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6 m-t-5">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::select('kategori_id', ['1' => 'Headset', '2' => 'Smartphone', '3' => 'Mouse', '4' => 'Makanan'], 1, ['class' => 'form-control show-tick', 'required'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
