                      ...
                      <div class="row clearfix">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::text('namabarang','Beng Beng',['class'=>'form-control', 'required', 'autofocus'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-md-5 col-xs-5 col-sm-5 col-lg-5">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::text('hargabarang','18000',['class'=>'form-control', 'required', 'autofocus', 'id'=>'harga'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::number('jumlahkeluar','7',['class'=>'form-control', 'required', 'autofocus', 'id'=>'jumlah'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6 m-t-5">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::select('satuanbarang', ['1' => 'Buah', '2' => 'Lusin'], 2, ['class' => 'form-control show-tick', 'required'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6 col-xs-6 col-sm-6 col-lg-6">
                                <div class="form-group">
                                    <div class="m-t-5">
                                        {{Form::text('jumlahharga','Rp 126.000,00',['disabled', 'required', 'autofocus', 'id'=>'jumlahharga'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-4 col-xs-4 col-sm-4 col-lg-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        {{Form::date('tanggal', \Carbon\Carbon::createFromDate(2018,4,28)->format('Y-m-d'),['class'=>'form-control', 'required', 'id'=> "tanggal"])}}
                                    </div>
